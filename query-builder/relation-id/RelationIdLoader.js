                            ...
                            case 3:
                                ...
                                joinColumnConditions = mappedColumns.map(function (mappedColumn, index) {
                                    return Object.keys(mappedColumn).map(function (key) {
                                        ...
                                        return _this.connection.driver.escape(junctionAlias_1) + "." + key + " = :" + parameterName;
                                    }).join(" AND ");
                                });
                                inverseJoinColumnCondition_1 = inverseJoinColumns_1.map(function (joinColumn) {
                                    return _this.connection.driver.escape(junctionAlias_1) + "." + joinColumn.propertyPath + " = " + inverseSideTableAlias_1 + "." + joinColumn.referencedColumn.propertyPath;
                                }).join(" AND ");
                                ...
                                inverseJoinColumns_1.forEach(function (joinColumn) {
                                    qb_2.addSelect(_this.connection.driver.escape(junctionAlias_1) + "." + joinColumn.propertyPath, joinColumn.databaseName)
                                        .addOrderBy(_this.connection.driver.escape(junctionAlias_1) + "." + joinColumn.propertyPath);
                                });
